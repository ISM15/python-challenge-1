...
while place_order:
    ...
    if menu_category.isdigit():
        ...
        if int(menu_category) in menu_items.keys():
            ...
            menu_selection = input("Please entre the menu item number:")
            ...
            if menu_selection.isdigit():
                ...
                if menu_selection in menu_items.keys():
                    ...
                    # Add the item name, price, and quantity to the order list  order = { "Item name": selected_item_ name,
                    order.append({
                         "Item name" : item_name,
                ...
                print("You didn't select a valid menu option. Please choose a valid item")
        else:
            # Tell the customer they didn't select a menu option
